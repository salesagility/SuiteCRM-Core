...
export class BaseEnumComponent extends BaseFieldComponent implements OnInit, OnDestroy {
    ...
    protected addConditionalOptions(options: Option[]): void {
        ...
        Object.values(conditionalOptions).forEach(extraOption => options.push(<Option>extraOption));
    }
    ...
    private getDynamicEnumOptions(parentEnum: Field | null, appStrings: LanguageListStringMap, parentFieldValue: FieldValue, prevOptions: Option[]): Option[] {
