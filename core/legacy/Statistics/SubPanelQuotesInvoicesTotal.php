...
class SubPanelQuotesInvoicesTotal extends SubpanelDataQueryHandler implements StatisticsProviderInterface
{
    use StatisticsHandlingTrait;

    public const KEY = 'quotes-invoices';
    ...
    {
        $subpanel = 'aos_quotes_aos_invoices';
