...
final class Version20230512153837 extends BaseMigration implements ContainerAwareInterface
{
    public function getDescription(): string
    {
        return 'Add default front end extension';
    }

    public function up(Schema $schema): void
    {
        $defaultExtensionPath = $this->getProjectDir() . '/extensions/default';
        if (file_exists($defaultExtensionPath)) {
            $this->log('Default extension already exists, skipping.');
            return;
        }
        ...
        $defaultExtensionPackage = $upgradePackagePath . '/extensions/default';
