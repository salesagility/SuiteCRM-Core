								...
								<tr>
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<tr>
												<th align="left" scope="row" colspan='3'>
													<div>
														<div>
															<span class="label label-warning" style="text-transform: none;">{$MOD.LBL_LDAP_LEGACY_WARNING}</span>
														</div>
														<div class="panel-body" style="text-transform: none; margin-top:10px">
															{$MOD.LBL_LDAP_LEGACY_WARNING_MORE}
														</div>
													</div>
