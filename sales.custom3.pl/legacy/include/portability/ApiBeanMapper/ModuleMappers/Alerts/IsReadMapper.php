...
class IsReadMapper implements FieldMapperInterface
{
    public const FIELD_NAME = 'is_read';
    ...
    public function toApi(SugarBean $bean, array &$container, string $alternativeName = ''): void
    {
        ...
        $isReadValue = $bean->is_read ?? false;
        if (empty($isReadValue) || isFalse($isReadValue)) {
