...
<p>&nbsp;</p>
<h1 style="margin: 0; padding: 0; font-size: 26pt; font-weight: normal; letter-spacing: 1pt; color: #3b3e51;">'.strtoupper(translate('LBL_PDF_NAME', 'AOS_Invoices')).'</h1>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="border: none; width: 55%; vertical-align: top;"><strong style="color: #3b3e51;">'.translate('LBL_INVOICE_NUMBER', 'AOS_Invoices').'</strong></td>
<td style="border: none; vertical-align: top;">$aos_invoices_number</td>
</tr>
<tr>
<td style="border: none; vertical-align: top;"><strong style="color: #3b3e51;">'.translate('LBL_INVOICE_DATE', 'AOS_Invoices').'</strong></td>
<td style="border: none; vertical-align: top;">$aos_invoices_invoice_date</td>
</tr>
<tr>
<td style="border: none; vertical-align: top;"><strong style="color: #3b3e51;">'.translate('LBL_DUE_DATE', 'AOS_Invoices').'</strong></td>
...
<td style="border-bottom: 1.5px solid #3b3e51; width: 14%; font-weight: bold; color: #3b3e51; text-align: center;">'.translate('LBL_PRODUCT_QUANITY', 'AOS_Invoices').'</td>
<td style="border-bottom: 1.5px solid #3b3e51; width: 13%; font-weight: bold; color: #3b3e51; text-align: right;">'.translate('LBL_LIST_PRICE', 'AOS_Invoices').'</td>
<td style="border-bottom: 1.5px solid #3b3e51; width: 14%; font-weight: bold; color: #3b3e51; text-align: right;">'.translate('LBL_DISCOUNT_AMT', 'AOS_Invoices').'</td>
<td style="border-bottom: 1.5px solid #3b3e51; width: 13%; font-weight: bold; color: #3b3e51; text-align: right;">'.translate('LBL_VAT', 'AOS_Invoices').'</td>
<td style="border-right: 1.5px solid #3b3e51; border-bottom: 1.5px solid #3b3e51; width: 16%; font-weight: bold; color: #3b3e51; text-align: right;">'.translate('LBL_TOTAL_PRICE', 'AOS_Invoices').'</td>
</tr>
<tr>
...
<td colspan="2" style="border-left: 1.5px solid #3b3e51; border-top: 2px solid #3b3e51; border-bottom: 1px solid #3b3e51; text-align: right;">'.translate('LBL_SUBTOTAL_AMOUNT', 'AOS_Invoices').'</td>
...
<tr>
<td colspan="3" style="border: none; padding: 0;"></td>
<td colspan="2" style="border-left: 1.5px solid #3b3e51; border-bottom: 1px solid #3b3e51; text-align: right;">'.translate('LBL_TAX_AMOUNT', 'AOS_Invoices').'</td>
...
<tr>
<td colspan="3" style="border: none; padding: 0;"></td>
<td colspan="2" style="border-left: 1.5px solid #3b3e51; border-top: 1.5px solid #3b3e51; border-bottom: 1.5px solid #3b3e51; font-weight: bold; color: #3b3e51; text-align: right;">'.translate('LBL_GROUP_TOTAL', 'AOS_Invoices').'</td>
...
<tr>
<td style="border-left: 1.5px solid #3b3e51; border-bottom: 1px solid #3b3e51; color: #3b3e51; width: 84%; text-align: right;">'.translate('LBL_SUBTOTAL_AMOUNT', 'AOS_Invoices').'</td>
...
<tr>
<td style="border-left: 1.5px solid #3b3e51; border-bottom: 1px solid #3b3e51; color: #3b3e51; width: 84%; text-align: right;">'.translate('LBL_TAX_AMOUNT', 'AOS_Invoices').'</td>
...
<tr>
<td style="border-left: 1.5px solid #3b3e51; border-top: 1.5px solid #3b3e51; border-bottom: 1.5px solid #3b3e51; font-weight: bold; color: #3b3e51; width: 84%; text-align: right;">'.translate('LBL_GRAND_TOTAL', 'AOS_Invoices').' $currencies_iso4217</td>
