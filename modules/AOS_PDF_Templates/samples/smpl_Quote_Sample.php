...
<p>&nbsp;</p>
<h1 style="margin: 0; padding: 0; font-size: 26pt; font-weight: normal; letter-spacing: 1pt;">'.strtoupper(translate('LBL_PDF_NAME', 'AOS_Quotes')).'</h1>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="border: none; width: 55%; vertical-align: top;"><strong style="color: #333333;">'.translate('LBL_QUOTE_NUMBER', 'AOS_Quotes').'</strong></td>
<td style="border: none; vertical-align: top;">$aos_quotes_number</td>
</tr>
<tr>
<td style="border: none; vertical-align: top;"><strong style="color: #333333;">'.translate('LBL_QUOTE_DATE', 'AOS_Quotes').'</strong></td>
<td style="border: none; vertical-align: top;">$aos_quotes_date_entered</td>
</tr>
<tr>
<td style="border: none; vertical-align: top;"><strong style="color: #333333;">'.translate('LBL_EXPIRATION', 'AOS_Quotes').'</strong></td>
<td style="border: none; vertical-align: top;">$aos_quotes_expiration</td>
</tr>
<tr>
<td style="border: none; vertical-align: top;"><strong style="color: #333333;">'.translate('LBL_TERM', 'AOS_Quotes').'</strong></td>
...
<tbody>
<tr>
<td style="border-bottom: 1.5px solid #333333; width: 30%; font-weight: bold; text-align: left;">'.translate('LBL_DESCRIPTION', 'AOS_Products').'</td>
<td style="border-bottom: 1.5px solid #333333; width: 14%; font-weight: bold; text-align: center;">'.translate('LBL_PRODUCT_QUANITY', 'AOS_Quotes').'</td>
<td style="border-bottom: 1.5px solid #333333; width: 13%; font-weight: bold; text-align: right;">'.translate('LBL_LIST_PRICE', 'AOS_Quotes').'</td>
<td style="border-bottom: 1.5px solid #333333; width: 14%; font-weight: bold; text-align: right;">'.translate('LBL_DISCOUNT_AMT', 'AOS_Quotes').'</td>
<td style="border-bottom: 1.5px solid #333333; width: 13%; font-weight: bold; text-align: right;">'.translate('LBL_VAT', 'AOS_Quotes').'</td>
<td style="border-bottom: 1.5px solid #333333; width: 16%; font-weight: bold; text-align: right;">'.translate('LBL_TOTAL_PRICE', 'AOS_Quotes').'</td>
</tr>
<tr>
...
<td colspan="2" style="border-bottom: 1px solid #dddddd; text-align: right;">'.translate('LBL_SUBTOTAL_AMOUNT', 'AOS_Quotes').'</td>
<td style="border-bottom: 1px solid #dddddd; text-align: right;">$subtotal_amount</td>
</tr>
<tr>
<td colspan="3" style="border: none; padding: 0;"></td>
<td colspan="2" style="border-bottom: 1px solid #dddddd; text-align: right;">'.translate('LBL_TAX_AMOUNT', 'AOS_Quotes').'</td>
<td style="border-bottom: 1px solid #dddddd; text-align: right;">$tax_amount</td>
</tr>
<tr>
<td colspan="3" style="border: none; padding: 0;"></td>
<td colspan="2" style="border-top: 1.5px solid #333333; border-bottom: 1.5px solid #333333; font-weight: bold; text-align: right;">'.translate('LBL_GRAND_TOTAL', 'AOS_Quotes').' $currencies_iso4217</td>
