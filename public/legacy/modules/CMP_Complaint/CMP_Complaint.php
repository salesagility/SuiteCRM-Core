...
class CMP_Complaint extends Incident
{
    public $new_schema = true;
    public $module_dir = 'CMP_Complaint';
    public $object_name = 'CMP_Complaint';
    public $table_name = 'cmp_complaint';
