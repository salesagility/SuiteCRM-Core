...
<table class='edit view small' width="100%" border="0" cellspacing="1" cellpadding="0" >		
	<tr valign="top">
		<td width="35%" class="connector-leftside">
			<table  border="0" cellspacing="2" cellpadding="0" >	
				<tr valign='top'>
					...
					<td class="border"><b>{$mod.LBL_MODIFY_PROPERTIES_TITLE}</b><br/>
				...
				<tr valign='top'>
					...
					<td class="mobile-hide">&nbsp;&nbsp;</td>
					<td class="border"><b>{$mod.LBL_MODIFY_DISPLAY_TITLE}</b><br/>
		...
		<td width="35%" class="connector-rightside">
			<table  border="0" cellspacing="2" cellpadding="0">	   
				<tr valign='top'>
					...
					<td>&nbsp;&nbsp;</td>
					<td class="border"><b>{$mod.LBL_MODIFY_MAPPING_TITLE}</b><br/>
