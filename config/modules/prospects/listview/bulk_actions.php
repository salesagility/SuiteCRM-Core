...
if (!isset($actions['modules']['prospects'])) {
    $actions['modules']['prospects'] = [];
}

if (!isset($actions['modules']['prospects']['actions'])) {
    $actions['modules']['prospects']['actions'] = [];
}

$actions['modules']['prospects']['actions']['records-to-target-list'] = [
