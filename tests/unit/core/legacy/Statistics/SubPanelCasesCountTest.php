...
use App\Tests\_mock\Mock\core\legacy\Statistics\SubPanelCasesCountMock;
...
/**
 * Class SubPanelCasesCount
 * @package App\Tests
 */
class SubPanelCasesCountTest extends Unit
{
    /**
     * @var UnitTester
     */
    ...
    protected function _before(): void
    {
        ...
        $this->handler = new SubPanelCasesCountMock(
            $projectDir,
            $legacyDir,
            $legacySessionName,
            $defaultSessionName,
    ...
    public function testUnsupportedContextModule(): void
    {
        ...
        static::assertEquals('cases', $result->getId());
