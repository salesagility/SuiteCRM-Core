...
use App\Tests\_mock\Mock\core\legacy\Statistics\SubPanelQuotesInvoicesTotalMock;
use App\Tests\UnitTester;
use Codeception\Test\Unit;
use Exception;

/**
 * Class SubPanelQuotesInvoicesTotal
 * @package App\Tests
 */
class SubPanelQuotesInvoicesTotalTest extends Unit
{
    /**
     * @var UnitTester
     */
    ...
    /**
     * @var SubPanelQuotesInvoicesTotalMock
     */
    private $handler;
    ...
    protected function _before(): void
    {
        ...
        $this->handler = new SubPanelQuotesInvoicesTotalMock(
            $projectDir,
            $legacyDir,
            $legacySessionName,
            $defaultSessionName,
    ...
    public function testUnsupportedContextModule(): void
    {
        ...
        static::assertEquals('quotes-invoices', $result->getId());
